    ...
    <>
      ...
      <section
        ...
        style={{
          position: "relative",
          padding:
            "clamp(8rem, 18vw, 12rem) var(--container-px) clamp(4rem, 8vw, 6rem)",
          textAlign: "center",
          overflow: "hidden",
        }}
      >
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              "url('https://images.unsplash.com/photo-1560869713-7d0a29430803?w=1600&q=80')",
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(180deg, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.15) 50%, var(--bg-primary) 100%)",
          }}
        />
        ...
        >
          ...
          >
            Từ một chi nhánh nhỏ đầy thử thách đến hệ thống 3 chi nhánh hôm nay
            — hành trình của sự kiên trì, đam mê và tận tâm.
          </p>
        </div>
      </section>
      ...
      >
        <div className="container">
          {/* Section header */}
          <div
            className="section-header reveal text-center"
          ...
          <div style={{ marginTop: "clamp(3rem, 7vw, 5rem)" }}>
            {history.milestones.map((m, i) => (
              ...
              >
                ...
                {/* Text */}
                <div
                  className={`zigzag-text zigzag-text-${i}`}
                  style={{ order: 1 }}
                >
                  <h3
                    className="t-h3"
                  ...
                  {branches.items[i] && (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <PhoneOutlined /> {branches.items[i].phone}
                        </span>
                        <span>·</span>
                        <span
                          style={{
                        ...
                        >
                          <ClockCircleOutlined /> {branches.items[i].hours}
                        </span>
                      </span>
                    </div>
                  )}
